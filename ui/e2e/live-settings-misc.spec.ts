...
const BASIC_AUTH_BLOCKLIST = `Basic ${Buffer.from('admin:testpass123').toString('base64')}`

test.describe('Live: Blocklist', () => {
  test.use({ extraHTTPHeaders: { Authorization: BASIC_AUTH_BLOCKLIST } })
  test.skip(!isLive, 'Only runs against live instance')

  let blockId: number | null = null

  // Auth is applied via extraHTTPHeaders above; stub kept for existing call sites.
