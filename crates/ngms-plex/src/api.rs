...
impl PlexApi {
    ...
    fn headers(&self) -> HeaderMap {
        ...
        headers.insert("X-Plex-Product", HeaderValue::from_static("NGMS"));
        headers.insert("X-Plex-Device-Name", HeaderValue::from_static("NGMS"));
        headers
    }
...
impl PlexTvApi {
    ...
    fn headers(&self) -> HeaderMap {
        ...
        headers.insert(
            ...
            HeaderValue::from_static("ngms-server"),
        );
        headers
    }
