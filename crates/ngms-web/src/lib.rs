...
pub fn build_router(state: Arc<AppState>) -> Router {
    ...
    let client_dir = std::env::var("NGMS_CLIENT_DIR").unwrap_or_else(|_| "/client".to_string());
    ...
    let ui_dir = std::env::var("NGMS_UI_DIR").unwrap_or_else(|_| "/ui".to_string());
...
mod tests {
    ...
    use ngms_core::test_helpers::{TestDb, seed_quality_profile};
    ...
    async fn test_state() -> (Arc<AppState>, TestDb) {
        ...
        let state = Arc::new(AppState {
            ...
            cardigann_engine: Arc::new(ngms_cardigann::CardigannEngine::new(std::path::Path::new(""))),
