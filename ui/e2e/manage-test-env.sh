...
# ── Config ──────────────────────────────────────────────────
# Set TEST_HOST and TEST_USER env vars to point at your test server
NODE_B="${TEST_USER:-admin}@${TEST_HOST:-192.168.1.100}"
REMOTE_DIR="${TEST_DATA_DIR:-/opt/stackarr_test}"
