...
use ngms_core::models::DownloadProtocol;
use ngms_indexer::newznab::Protocol;
use ngms_indexer::search::TextSearchCriteria;
...
fn to_search_result(r: ngms_indexer::ReleaseInfo) -> SearchResult {
    SearchResult {
        guid: r.guid,
        title: r.title,
