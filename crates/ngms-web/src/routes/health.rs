...
async fn prometheus_metrics(State(state): State<Arc<AppState>>) -> impl IntoResponse {
    ...
    let body = format!(
        "# HELP ngms_series_total Total number of series\n\
         # TYPE ngms_series_total gauge\n\
         ngms_series_total {series_count}\n\
         # HELP ngms_series_monitored Number of monitored series\n\
         # TYPE ngms_series_monitored gauge\n\
         ngms_series_monitored {monitored_series}\n\
         # HELP ngms_movies_total Total number of movies\n\
         # TYPE ngms_movies_total gauge\n\
         ngms_movies_total {movies_count}\n\
         # HELP ngms_movies_monitored Number of monitored movies\n\
         # TYPE ngms_movies_monitored gauge\n\
         ngms_movies_monitored {monitored_movies}\n\
         # HELP ngms_episodes_total Total number of episodes\n\
         # TYPE ngms_episodes_total gauge\n\
         ngms_episodes_total {episodes_count}\n\
         # HELP ngms_media_files_total Total number of media files on disk\n\
         # TYPE ngms_media_files_total gauge\n\
         ngms_media_files_total {media_files_count}\n\
         # HELP ngms_queue_total Items currently in download queue\n\
         # TYPE ngms_queue_total gauge\n\
         ngms_queue_total {queue_count}\n\
         # HELP ngms_history_total Total history events\n\
         # TYPE ngms_history_total gauge\n\
         ngms_history_total {history_count}\n\
         # HELP ngms_blocklist_total Blocklisted releases\n\
         # TYPE ngms_blocklist_total gauge\n\
         ngms_blocklist_total {blocklist_count}\n\
         # HELP ngms_indexers_enabled Enabled indexers\n\
         # TYPE ngms_indexers_enabled gauge\n\
         ngms_indexers_enabled {indexers_count}\n\
         # HELP ngms_download_clients_enabled Enabled download clients\n\
         # TYPE ngms_download_clients_enabled gauge\n\
         ngms_download_clients_enabled {clients_count}\n"
    );
