            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <FeatureToggle
                  ...
                  warning={!indexarrAvailable ? 'Indexarr container not deployed. Set NGMS_INDEXARR_ENABLED=true in your compose environment and start the indexarr service.' : undefined}
                />
                <FeatureToggle
